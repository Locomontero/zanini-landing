...
export function Copos() {
  const coposGallery = [
    {
      url: portfolio1,
      title: "Copos Térmicos CASE IH",
      description: "Copo térmico personalizado com gravação laser",
    },
    {
      url: portfolio3,
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <h1 className="text-6xl font-black mb-4">
                <span className="text-red-500">Copos</span> Personalizados
              </h1>
              <p className="text-xl text-neutral-400 max-w-2xl mx-auto">
                Copos térmicos, canecas e muito mais com gravação laser de alta qualidade
              </p>
            </motion.div>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {coposGallery.map((item, index) => (
                <motion.div
                  key={index}
